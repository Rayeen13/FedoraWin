...
assert.match(main, /only the panel stays resident/);
assert.match(main, /set_low_memory_target/);
...
assert.match(performance, /SetMemoryUsageTargetLevel/);
assert.match(performance, /COREWEBVIEW2_MEMORY_USAGE_TARGET_LEVEL_LOW/);

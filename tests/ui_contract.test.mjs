...
const frameOverlay = fs.readFileSync(new URL('../src-tauri/src/windows/frame_overlay.rs', import.meta.url), 'utf8');
...
assert.match(frameOverlay, /DWMWA_CAPTION_BUTTON_BOUNDS/);
assert.match(frameOverlay, /DWMWA_EXTENDED_FRAME_BOUNDS/);
assert.match(frameOverlay, /FedoraWin\.AdwaitaCaptionButtons/);
assert.match(frameOverlay, /SC_MINIMIZE/);
assert.match(frameOverlay, /SC_MAXIMIZE/);
assert.match(frameOverlay, /SC_RESTORE/);
assert.match(frameOverlay, /SC_CLOSE/);
assert.match(frameOverlay, /WS_EX_NOACTIVATE/);
assert.match(frameOverlay, /SendMessageW/);
assert.match(frameOverlay, /PostThreadMessageW/);
assert.match(frameOverlay, /WM_APP_FRAME_SYNC/);
assert.match(frameOverlay, /TIMER_RECONCILE/);
assert.doesNotMatch(frameOverlay, /from_millis\(120\)/);
...
assert.match(windowEvents, /frame_overlay::notify/);
...
assert.match(main, /frame_overlay::start/);
assert.match(main, /frame_overlay::notify/);
assert.match(main, /frame_overlay::stop/);
